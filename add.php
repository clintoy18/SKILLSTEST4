...
<body>
    ...
    <?= $jsAlert ?>
     <form action="" method="post">
            ...
            <input type="number" name="copyright" placeholder="Enter copyright" min="1900" max="2025" required  ><br>
            <label for="edition">Enter edition</label>
            <input type="text" name="edition" placeholder="Enter edition" require><br>
